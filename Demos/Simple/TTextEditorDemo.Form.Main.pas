...
uses
  Winapi.Windows, System.Actions, System.Classes, System.SysUtils, Vcl.ActnList, Vcl.ComCtrls, Vcl.Controls, Vcl.ExtCtrls, Vcl.Forms,
  Vcl.Menus, Vcl.StdCtrls, TextEditor, TextEditor.Types;
...
begin
  TextEditor.ZoomPercentage := TAction(Sender).Tag;
