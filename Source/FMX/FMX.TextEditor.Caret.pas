unit FMX.TextEditor.Caret;

interface

uses
  System.Classes, FMX.TextEditor.Caret.MultiEdit, FMX.TextEditor.Caret.NonBlinking, FMX.TextEditor.Caret.Offsets, FMX.TextEditor.Caret.Styles,
...
type
  ...
  published
    property BlinkingInterval: Integer read FBlinkingInterval write FBlinkingInterval default 500;
...
begin
  ...
  begin
    Self.FBlinkingInterval := FBlinkingInterval;
