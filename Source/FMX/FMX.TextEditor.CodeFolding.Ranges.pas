unit FMX.TextEditor.CodeFolding.Ranges;

interface

uses
  System.Classes, System.SysUtils, System.Types, FMX.TextEditor.CodeFolding.Regions;
...
type
  ...
  public
    ...
    property CollapseMarkRect: TRectF read FCollapseMarkRect write FCollapseMarkRect;
...
begin
  for var LIndex := FList.Count - 1 downto 0 do
...
begin
  Result := if Cardinal(AIndex) < Cardinal(FList.Count) then FList.List[AIndex] else nil;
end;
...
begin
  for var LIndex := 0 to AllCount - 1 do
  begin
...
begin
  for var LIndex := 0 to FSubCodeFoldingRanges.Count - 1 do
  begin
