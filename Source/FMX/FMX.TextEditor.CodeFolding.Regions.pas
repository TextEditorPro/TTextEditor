unit FMX.TextEditor.CodeFolding.Regions;

interface

uses
  System.Classes, System.SysUtils, FMX.TextEditor.Consts, FMX.TextEditor.SkipRegions, FMX.TextEditor.Types;
...
type
  ...
  strict private
    FAlternativeCloseToken: string;
    FAlternativeCloseTokenLength: Integer;
  ...
  public
    ...
    property AlternativeCloseToken: string read FAlternativeCloseToken write FAlternativeCloseToken;
    property AlternativeCloseTokenLength: Integer read FAlternativeCloseTokenLength write FAlternativeCloseTokenLength;
  ...
  public
    ...
    function Add(const AOpenToken: string; const ACloseToken: string; const AAlternativeCloseToken: string = ''): TTextEditorCodeFoldingRegionItem;
...
function TTextEditorCodeFoldingRegion.Add(const AOpenToken: string; const ACloseToken: string; const AAlternativeCloseToken: string = ''): TTextEditorCodeFoldingRegionItem;
var
...
begin
  ...
  begin
    ...
    AlternativeCloseToken := AAlternativeCloseToken;
    AlternativeCloseTokenLength := AAlternativeCloseToken.Length;
  end;
end;
