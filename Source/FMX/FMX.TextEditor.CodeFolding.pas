unit FMX.TextEditor.CodeFolding;

interface

uses
  System.Classes, System.SysUtils, FMX.TextEditor.CodeFolding.GuideLines, FMX.TextEditor.CodeFolding.Hint, FMX.TextEditor.TextFolding, FMX.TextEditor.Types;
...
procedure TTextEditorCodeFolding.SetAutoHide(const AValue: Boolean);
begin
  if FAutoHide <> AValue then
  begin
    FAutoHide := AValue;
