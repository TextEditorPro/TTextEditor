unit FMX.TextEditor.CompletionProposal.Snippets;
...
uses
  System.Classes, System.SysUtils, FMX.TextEditor.Types;
...
begin
  Result := if FKeyword.IsEmpty then STextEditorCompletionProposalSnippetItemUnnamed else FKeyword;
end;
