unit FMX.TextEditor.LeftMargin;
...
type
  ...
  TLeftMarginPaintEvent = procedure(ASender: TObject; ALine: Integer; X, Y: Single) of object;
  TLeftMarginClickEvent = procedure(ASender: TObject; AButton: TMouseButton; X, Y: Single; ALine: Integer; AMark: TTextEditorMark) of object;
  ...
  public
    ...
    function RealLeftMarginWidth(const ACharWidth: Single): Single;
...
function TTextEditorLeftMargin.RealLeftMarginWidth(const ACharWidth: Single): Single;
var
  LPanelWidth: Integer;
begin
...
begin
  ...
  for var LIndex := 1 to FLineNumbers.AutosizeDigitCount - 1 do
  begin
