unit FMX.TextEditor.Print.Margins;

interface

uses
  System.Classes, System.SysUtils, FMX.Graphics, FMX.TextEditor.Print.PrinterInfo, FMX.TextEditor.Types, FMX.TextEditor.Utils;
...
begin
  ...
  if ALineNumbers and (not ALineNumbersInMargin) then
    PixelLeft := PixelLeft + Round(TextWidth(ACanvas, IntToStr(AMaxLineNumber) + ': '));
