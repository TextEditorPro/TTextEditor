unit FMX.TextEditor.Search;

interface

uses
  System.Classes, FMX.TextEditor.Search.InSelection, FMX.TextEditor.Search.Map, FMX.TextEditor.Search.NearOperator, FMX.TextEditor.Types;
...
begin
  for var LIndex := FItems.Count - 1 downto 0 do
