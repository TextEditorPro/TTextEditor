unit FMX.TextEditor.SpecialChars;

interface

uses
  System.Classes, System.UITypes, FMX.TextEditor.SpecialChars.LineBreak, FMX.TextEditor.SpecialChars.Selection, FMX.TextEditor.Types;
...
procedure TTextEditorSpecialChars.SetColor(const AValue: TAlphaColor);
begin
