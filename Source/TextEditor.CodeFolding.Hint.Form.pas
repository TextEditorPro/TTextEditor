...
begin
  FFont.Assign(AValue);
  { The editor zooms its fonts by raising Height and PixelsPerInch together - Assign converts the height
    back to this font's PixelsPerInch, undoing the zoom. Keep the source pixel height. }
  FFont.Height := AValue.Height;
