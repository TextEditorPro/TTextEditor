...
type
  ...
  strict private
    ...
    FBookmarkGreen: TColor;
    FBookmarkLineBackground: TColor;
    FBookmarkPurple: TColor;
    FBookmarkRed: TColor;
    FBookmarkYellow: TColor;
    ...
    FCompareBackground: TColor;
    FCompareForeground: TColor;
    ...
    FHintBackground: TColor;
    FHintBorder: TColor;
    FHintText: TColor;
    FInDesign: Boolean;
    FKeywordImageArrowDown: TColor;
    FKeywordImageArrowUp: TColor;
    ...
    procedure SetBookmarkGreen(const AValue: TColor);
    procedure SetBookmarkLineBackground(const AValue: TColor);
    procedure SetBookmarkPurple(const AValue: TColor);
    procedure SetBookmarkRed(const AValue: TColor);
    procedure SetBookmarkYellow(const AValue: TColor);
    ...
    procedure SetCompareBackground(const AValue: TColor);
    procedure SetCompareForeground(const AValue: TColor);
    ...
    procedure SetHintBackground(const AValue: TColor);
    procedure SetHintBorder(const AValue: TColor);
    procedure SetHintText(const AValue: TColor);
    procedure SetKeywordImageArrowDown(const AValue: TColor);
    procedure SetKeywordImageArrowUp(const AValue: TColor);
  ...
  published
    ...
    property BookmarkGreen: TColor read FBookmarkGreen write SetBookmarkGreen default TDefaultColors.BookmarkGreen;
    ...
    property BookmarkPurple: TColor read FBookmarkPurple write SetBookmarkPurple default TDefaultColors.BookmarkPurple;
    property BookmarkRed: TColor read FBookmarkRed write SetBookmarkRed default TDefaultColors.BookmarkRed;
    property BookmarkYellow: TColor read FBookmarkYellow write SetBookmarkYellow default TDefaultColors.BookmarkYellow;
    ...
    property CompareBackground: TColor read FCompareBackground write SetCompareBackground default TDefaultColors.PaleRed;
    property CompareForeground: TColor read FCompareForeground write SetCompareForeground default TDefaultColors.Red;
    ...
    property HintBackground: TColor read FHintBackground write SetHintBackground default TColors.SysInfoBk;
    property HintBorder: TColor read FHintBorder write SetHintBorder default TDefaultColors.LineNumbers;
    property HintText: TColor read FHintText write SetHintText default TColors.SysInfoText;
    property KeywordImageArrowDown: TColor read FKeywordImageArrowDown write SetKeywordImageArrowDown default TDefaultColors.KeywordImageArrowDown;
    property KeywordImageArrowUp: TColor read FKeywordImageArrowUp write SetKeywordImageArrowUp default TDefaultColors.KeywordImageArrowUp;
...
begin
  ...
  { Hint }
  FHintBackground := TColors.SysInfoBk;
  FHintBorder := TDefaultColors.LineNumbers;
  FHintText := TColors.SysInfoText;
...
begin
  Result := if AColor = TColors.SysDefault then ADefault else AColor;
end;
...
procedure TTextEditorColors.SetBookmarkBlue(const AValue: TColor);
begin
  FBookmarkBlue := SetColorDef(AValue, TDefaultColors.BookmarkBlue);
end;

procedure TTextEditorColors.SetBookmarkGreen(const AValue: TColor);
begin
...
procedure TTextEditorColors.SetBookmarkPurple(const AValue: TColor);
begin
  FBookmarkPurple := SetColorDef(AValue, TDefaultColors.BookmarkPurple);
end;

procedure TTextEditorColors.SetBookmarkRed(const AValue: TColor);
begin
  FBookmarkRed := SetColorDef(AValue, TDefaultColors.BookmarkRed);
end;

procedure TTextEditorColors.SetBookmarkYellow(const AValue: TColor);
begin
...
procedure TTextEditorColors.SetCompareBackground(const AValue: TColor);
begin
  FCompareBackground := SetColorDef(AValue, TDefaultColors.PaleRed);
end;

procedure TTextEditorColors.SetCompareForeground(const AValue: TColor);
begin
...
procedure TTextEditorColors.SetHintBackground(const AValue: TColor);
begin
  FHintBackground := SetColorDef(AValue, TColors.SysInfoBk);
end;

procedure TTextEditorColors.SetHintBorder(const AValue: TColor);
begin
  FHintBorder := SetColorDef(AValue, TDefaultColors.LineNumbers);
end;

procedure TTextEditorColors.SetHintText(const AValue: TColor);
begin
  FHintText := SetColorDef(AValue, TColors.SysInfoText);
end;

procedure TTextEditorColors.SetKeywordImageArrowDown(const AValue: TColor);
begin
  FKeywordImageArrowDown := SetColorDef(AValue, TDefaultColors.KeywordImageArrowDown);
end;

procedure TTextEditorColors.SetKeywordImageArrowUp(const AValue: TColor);
begin
