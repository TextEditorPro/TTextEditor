...
procedure TCustomEditorMacroRecorder.StateChanged;
  ...
  procedure SetEditorMacroState(const AEditor: TCustomControl);
  begin
...
procedure TCustomEditorMacroRecorder.HookEditor(const AEditor: TCustomControl; const ACommandID: TTextEditorCommand; const AOldShortCut, ANewShortCut: TShortCut);
var
...
procedure TCustomEditorMacroRecorder.UnHookEditor(const AEditor: TCustomControl; const ACommandID: TTextEditorCommand; const AShortCut: TShortCut);
var
  LEditor: TCustomTextEditor;
  LIndex: Integer;
begin
...
initialization
  ...
  GroupDescendentsWith(TCustomEditorMacroRecorder, Vcl.Controls.TControl);
