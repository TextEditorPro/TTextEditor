...
uses
  Winapi.Windows, System.Classes, System.SysUtils, System.UITypes, Vcl.Graphics, TextEditor.Print.Margins, TextEditor.Types,
  TextEditor.Utils;
...
begin
  ...
  begin
    ...
    FFrameHeight := Max(FFrameHeight, LOriginalHeight + TextHeight(ACanvas, 'W'));
  end;
