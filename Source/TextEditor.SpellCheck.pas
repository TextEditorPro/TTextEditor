...
var
  ...
  begin
    Result := (LErrorItem^.Line > ATextPosition.Line) or (LErrorItem^.Line = ATextPosition.Line) and (LErrorItem^.Char >= ATextPosition.Char);
  end;
...
begin
  ...
  for var LIndex := 0 to LListCount - 1 do
