...
begin
  ...
  begin
    ...
    if (ATextPosition.Char > 0) and (ATextPosition.Char <= LLength) then
...
var
  ...
  procedure DrawMark(const AMark: TTextEditorMark; var AOverlappingOffset: Integer; const AMarkRow: Integer);
  var
    LY: Integer;
    LRow: Integer;
  begin
